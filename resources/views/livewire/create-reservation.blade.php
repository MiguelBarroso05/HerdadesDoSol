        ...
        <div class="hs-d-flex ">
            ...
            <div class="hs-bg-gradient-warning hs-w-30 hs-p-3">
                <div class="hs-d-inline-flex justify-between">
                    <div class="hs-w-45">
                        <livewire:NumberInput wire:model="groupsize" wire:change="loadData" :name="'groupsize'" :value="$groupsize" />
                    </div>
                    <div class="hs-w-45">
                        <livewire:NumberInput wire:model="children" wire:change="loadData" :name="'children'" :value="$children" />
                    </div>
                </div>
                <div class="relative">
                    <x-dropdown-input id="{{ now() }}" wire:model="selectedAccommodationTypeId"
                        ...
                        :name="'accommodation_types'" :object="$accommodationTypes" :optionText="'name'" :user="auth()->user()" :paramter="null" />
