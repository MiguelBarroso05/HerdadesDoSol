        ...
        "
            ...
            "extraMarkup": "<div class=\"absolute top-1/2 end-3 -translate-y-1/2\"><svg class=\"shrink-0 size-3.5 text-gray-500 dark:text-neutral-500 \" xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"m7 15 5 5 5-5\"/><path d=\"m7 9 5-5 5 5\"/></svg></div>"
                       ...
                       >
                           <option
                               value=""
                               @selected(!auth()->user()->fav_estate)
                               @disabled($selectedEstateId)
                               @if($selectedEstateId) hidden @endif
                           >Select a Estate</option>
            ...
            <div class="relative {{ (($selectedEstateId || $user->fav_estate) && $entryDate && $exitDate) ? '' : 'hs-d-none' }}">
                   <div class="hs-form-group">
                       <label for="accommodation_types" class="hs-form-control-label text-white"> Accommodation
                           Type</label>
                       <x-reservation-select wire:model="selectedAccommodationTypeId"  id="{{ now() }}"
                           ...
                           :set="'selectedAccommodationTypeId'" :call="'show_accommodations'"
                           :paramter="null"/>
                   </div>
                   <div class="hs-form-group">
