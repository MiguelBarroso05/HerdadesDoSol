    ...
    <div class="hs-bg-gradient-danger hs-w-70">
        <form wire:submit="submit">
            <div class="hs-bg-dark hs-w-100 hs-py-3 hs-d-inline-flex hs-justify-content-between hs-px-1">
                ...
                <!-- End Select -->
                <div class="hs-w-25">
                    <x-datetime-picker wire:model.live="entryDate" wire:change="setEntryDate($event.target.value)" value="{{ $entryDate }}" id="entry_date"
                         placeholder="Appointment Date"  />
                </div>
                <div class="hs-w-25">
                    <x-datetime-picker wire:model.live="exitDate" wire:change="setExitDate($event.target.value)" value="{{ $exitDate }}" id="departure_date"
                        placeholder="Appointment Date"  />
                </div>
            </div>
