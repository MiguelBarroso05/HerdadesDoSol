...
@section('content')
    ...
    <main class="hs-d-flex hs-flex-grow-1 hs-mt-8 hs-px-9 hs-justify-content-center hs-mb-2">
        ...
        <div
            ...
            <form class="hs-d-flex hs-flex-column hs-justify-content-center hs-align-items-center hs-w-25"
                action="{{ route('verification.send') }}" method="POST">
                @csrf
                <button type="submit" class="hs-btn hs-btn-primary hs-mt-5 hs-w-80">Resend Verification Email</button>
            </form>
        </div>
    </main>
@endsection
