                        ...
                        <div class="hs-col-xl-4 hs-col-lg-5 hs-col-md-7 hs-d-flex hs-flex-column hs-mx-lg-0 hs-mx-auto">
                            <div class="hs-card hs-card-plain">
                                <div class="hs-card-header hs-pb-0 hs-text-start">
                                    <h4 class="hs-font-weight-bolder">Change password</h4>
                                    <p class="hs-mb-0">Set a new password for your email</p>
                                </div>
                                <div class="hs-card-body">
                                    <form role="form" method="POST" action="{{ route('change.perform') }}">
                                        ...
                                        <div class="hs-flex hs-flex-col hs-mb-3">
                                            <input type="password" name="password" class="hs-form-control hs-form-control-lg" placeholder="Password" aria-label="Password">
                                            @error('password') <p class="hs-text-danger hs-text-xs hs-pt-1"> {{$message}} </p>@enderror
                                        </div>
                                        <div class="hs-flex hs-flex-col hs-mb-3">
                                            <input type="password" name="confirm-password" class="hs-form-control hs-form-control-lg" placeholder="Confirm Password" aria-label="Password">
                                            @error('confirm-password') <p class="hs-text-danger hs-text-xs hs-pt-1"> {{$message}} </p>@enderror
                                        </div>
                                        <div class="hs-text-center">
                                            <button type="submit" class="hs-btn hs-btn-lg hs-btn-primary hs-w-100 hs-mt-4 hs-mb-0">Change Password</button>
                                        </div>
                                    </form>
                                </div>
                                <div id="alert">
