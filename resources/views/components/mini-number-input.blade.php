<div class="py-2 flex justify-center bg-white border border-gray-200 rounded-lg dark:bg-neutral-900 dark:border-neutral-700" data-hs-input-number='{"max": 8}'  style="height: 34px;">
    <div class="flex items-center gap-x-1.5">
        ...
        <input class="p-0 w-6 bg-transparent border-0 text-gray-800 text-center focus:ring-0 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none dark:text-white @error($name) hs-is-invalid @enderror" style="-moz-appearance: textfield;" type="number" aria-roledescription="Number field" name="{{$name}}" value="{{$value}}" data-hs-input-number-input="" readonly>
